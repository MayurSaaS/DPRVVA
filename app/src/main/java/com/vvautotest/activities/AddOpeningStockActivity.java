...
public class AddOpeningStockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_opening_stock);
    ...
    private void loadSpinner()
    {
        ...
        categoryAdapter = new SpinnerAdapter(AddOpeningStockActivity.this, categoryDataArrayList);
