...
public class AddFundRequestActivity extends AppCompatActivity {
    ...
    {
        categoryDataArrayList = DummyData.loadFundType();
        categoryAdapter = new SpinnerAdapter(AddFundRequestActivity.this, categoryDataArrayList);
