...
public class AddDMCEntryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dmcentry);
    ...
    private void loadSpinner()
    {
        ...
        categoryAdapter = new SpinnerAdapter(AddDMCEntryActivity.this, categoryDataArrayList);
