...
public class AddLeaveApplicationActivity extends AppCompatActivity {
    ...
    {
        categoryDataArrayList = DummyData.loadLeaveType();
        categoryAdapter = new SpinnerAdapter(AddLeaveApplicationActivity.this, categoryDataArrayList);
    ...
    {
        categoryDataArrayList2 = DummyData.loadLeaveCategory();
        categoryAdapter2 = new SpinnerAdapter(AddLeaveApplicationActivity.this, categoryDataArrayList2);
