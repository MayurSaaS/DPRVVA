...
public class AddReceiptStockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_receipt_stock);
    ...
    private void loadSpinner()
    {
        ...
        categoryAdapter = new SpinnerAdapter(AddReceiptStockActivity.this, categoryDataArrayList);
